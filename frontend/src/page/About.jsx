...
const features = [
  ...
  },
  {
    ...
    description:
      "Get notified immediately when prices drop or products go on sale.",
  },
  {
...
const About = () => {
  return (
    <div className="container py-16 mb-4">
      {/* Hero Section */}
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
        {stats.map((stat, index) => (
          <Card
            key={index}
            className="bg-dark-800/50 border-dark-700 text-center backdrop-blur-sm hover:border-primary-500/50 transition-all duration-300"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16 items-center">
        <div>
          ...
          <p className="text-gray-300 mb-6">
            At PriceTracker, we believe that everyone deserves to get the best
            value for their money. Our mission is to empower consumers with the
            tools they need to make informed purchasing decisions and save money
            on the products they love.
          </p>
          <p className="text-gray-300 mb-6">
            Founded in 2023, we&apos;ve helped thousands of users save thousands
            of dollars by tracking prices and providing timely alerts when
            products go on sale.
          </p>
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <Card
              key={index}
              className="bg-dark-800/50 border-dark-700 hover:border-primary-500/50 transition-all duration-300 backdrop-blur-sm"
            >
      ...
      <div className="mb-16">
        ...
        <div className="flex flex-row justify-center items-center gap-6">
          {team.map((member, index) => (
            <Card
              key={index}
              className="bg-dark-800/50 border-dark-700 text-center backdrop-blur-sm hover:border-primary-500/50 transition-all duration-300 cursor-pointer"
            >
              <CardContent className="p-6">
      ...
      {/* CTA Section */}
      <div className="bg-gradient-to-r from-primary-600/20 to-secondary-600/20 rounded-2xl p-8 text-center border border-primary-500/30 backdrop-blur-sm mb-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Button
            variant="outline"
            className="border-white text-white hover:bg-white/10 px-8 py-3 rounded-lg text-base backdrop-blur-sm"
          >
            Learn More
          </Button>
        </div>
